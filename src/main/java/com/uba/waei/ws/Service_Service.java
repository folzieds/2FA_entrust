 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://ws.waei.uba.com/", wsdlLocation = "http://172.20.236.2:7808/entrust3/service?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName SERVICE_QNAME = new QName("http://ws.waei.uba.com/", "Service");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://172.20.236.2:7808/entrust3/service?wsdl");
    ...
    public com.uba.waei.ws.Service getServicePort() {
        return super.getPort(new QName("http://ws.waei.uba.com/", "ServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public com.uba.waei.ws.Service getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.waei.uba.com/", "ServicePort"), Service.class, features);
    }
